...
<!--                  <div class="slide-inner">
                    ...
                    <div class="slide-item">
                      <img style="height: 100%; width: auto; cursor:pointer;" onclick="window.location='como.php'"
                        src="themes/images/index1.jpg">
                        <div class="text-block">
                        <h4>¿Como Funciona?</h4>
    <p>Haz Click para Ver como Funciona VerifyDoc</p>
  </div>
                    ...
                    <input class="slide-open" type="radio" id="slide-2"
                      name="slide" aria-hidden="true" hidden="">
                    <div class="slide-item">
                      <img style="height: 100%; width: auto;cursor:pointer;" onclick="window.location='mision.php'"
                        src="themes/images/index4.jpg">
                        <div class="text-block">
    <h4>Nuestra Mision y Valores</h4>
    <p>Haz Click para poder Leerlos</p>
  </div>
                    ...
                    <input class="slide-open" type="radio" id="slide-3"
                      name="slide" aria-hidden="true" hidden="">
                    <div class="slide-item">
                      <img style="height: 100%; width: auto; cursor:pointer;" onclick="window.location='precio.php'"
                        src="themes/images/index3.jpg">
                        <div class="text-block">
    <h4>Consulte Nuestros Planes</h4>
    <p>Haz Click para Ver los Planes Disponibles</p>
  </div>
...
<div class="slider">
			<ul>
				<li>
  <img style="height: 250%; width: auto; cursor:pointer;" onclick="window.location='como.php'" src="themes/images/index1.svg" alt="">
 </li>
				<li>
  <img style="height: 250%; width: auto; cursor:pointer;" onclick="window.location='mision.php'" src="themes/images/index4.svg" alt="">
</li>
				<li>
  <img style="height: 250%; width: auto; cursor:pointer;" onclick="window.location='precio.php'" src="themes/images/index3.svg" alt="">
</li>
			<li>
  <img style="height: 250%; width: auto; cursor:pointer;" onclick="window.location='quien.php'" src="themes/images/index5.svg" alt="">
</li>
			</ul>
		</div>
